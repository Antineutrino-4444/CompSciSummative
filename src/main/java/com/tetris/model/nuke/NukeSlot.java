...
public final class NukeSlot {
    ...
    private NukeSlot(String id, String name, String description, NukePart... options) {
        ...
        // NONE is the implicit "no selection" state — every slot defaults
        // to it via NukeDesign — but it is no longer offered as a
        // selectable option in the parts list.
    ...
    public static final NukeSlot CONFIGURATION = new NukeSlot("config",
        ...
        // Explicit "none" entry — every other slot is implicitly NONE
        // until the user picks something, but the configuration slot
        // is the one slot the rest of the UI gates on, so it gets a
        // visible "no architecture chosen" option in the parts list
        // for users who want to clear their selection.
        NukePart.NONE,
    ...
    public static final NukeSlot CASING = new NukeSlot("casing",
        ...
        new NukePart("Cylindrical artillery shell body",
            ...
            "W33, W48, W79. Forces the use of gun-type assembly. " +
