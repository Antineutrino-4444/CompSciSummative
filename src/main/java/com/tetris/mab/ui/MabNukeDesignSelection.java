...
public final class MabNukeDesignSelection {
    ...
    /** Original builder model that produced this selection, retained so
     *  mid-game redesign can seed the integrated builder with the
     *  player's last design. {@code null} for default selections. */
    private final com.tetris.model.nuke.NukeDesign builderSource;

    private MabNukeDesignSelection(Source source, NukeDesign design, String summary,
                                   com.tetris.model.nuke.NukeDesign builderSource) {
    ...
    public static MabNukeDesignSelection defaultSelection() {
        ...
        return new MabNukeDesignSelection(Source.DEFAULT_DOCTRINE, d,
                BRIDGE.safeGameplaySummary(d), null);
    }
    ...
    public static MabNukeDesignSelection fromBuilderDesign(
        ...
        return new MabNukeDesignSelection(Source.BUILDER_DERIVED, d,
                BRIDGE.safeGameplaySummary(d), builderDesign);
    }
    ...
    /** Optional builder model that produced this selection, or {@code null}
     *  if the selection came from a default/MAB-only source. */
    public com.tetris.model.nuke.NukeDesign getBuilderSource() { return builderSource; }
